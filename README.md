# **Sales Forecasting Using the Prophet Model**
...
The company needs to plan for inventory, staffing, and resource allocation. However, making informed decisions is difficult without clear visibility into future sales trends. The core challenge lies in the absence of reliable forecasting tools that can accurately predict monthly sales based on past purchasing behavior.

### **2. Project Goal**

To develop a robust, data-driven forecasting model using Facebook’s Prophet that predicts monthly sales for the next 24 months. This model will support strategic planning and informed decision-making across operations, finance, and supply chain departments.

## **III. Approach**

**1. Data Cleaning**

- Clean and standardize the dataset to remove errors, ensure consistency, and create a reliable foundation for accurate forecasting.

**2. Feature Expansion**

- Enrich the dataset with additional variables that provide contextual insights and improve model performance.

**3. Data Aggregation**

- Resample historical order-level data into monthly sales totals to uncover underlying trends and seasonal patterns.

**4. Modeling**

- Implement Facebook’s Prophet time series model, known for handling seasonality, trend changes, and holiday effects effectively.

**5. Forecasting**

- Generate 24-month sales forecasts along with uncertainty intervals to account for prediction variability.

**6. Visualization**

- Present actual and forecasted sales in a clear, visual format to help stakeholders understand projections and plan accordingly.

**7. Deliverables**

- Provide a forecast table with upper and lower bounds for monthly sales, along with visual insights.
